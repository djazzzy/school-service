 ...
 */
class Userupd extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        return [
            [['login', 'username', 'lastname', 'middle_name', 'school', 'school_class', 'birthday', 'email', 'password', 'password2'], 'filter', 'filter' => 'trim'],
